...
class OdrGetContactDetailsTest extends UnitTestCase
{
    ...
    public function testError()
    {
        ...
        self::assertEquals(array('error' => 'Following error occurred: Forced error'), odr_GetContactDetails($data));
    }
    ...
    public function testException()
    {
        ...
        self::assertEquals(array('error' => 'Following error occurred: ' . $module::MESSAGE_CURL_ERROR_FOUND), odr_GetContactDetails($data));
    }
}