...
class OdrGetDomainSuggestionsTest extends UnitTestCase
{
    public function testNotLoggedIn()
    {
        ...
        self::assertEquals(array('status' => \Odr_Whmcs::STATUS_ERROR, 'error' => 'Can\'t login, reason - Forced error'), odr_GetDomainSuggestions($data));
    }
    ...
    public function testError()
    {
        ...
        $result = odr_GetDomainSuggestions($data);
    ...
    public function testException()
    {
        ...
        self::assertEquals(array('error' => 'Following error occurred: ' . $module::MESSAGE_CURL_ERROR_FOUND), odr_GetDomainSuggestions($data));
    }
